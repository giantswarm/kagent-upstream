...
// ResolveArtifactCredentials turns the artifact credential variables of
// environment into the literals their Secret keys hold.
func (c *Builder) ResolveArtifactCredentials(namespace string, environment []corev1.EnvVar) ([]corev1.EnvVar, error) {
	return v2translator.ResolveArtifactCredentials(c.ctx, c.collections, namespace, environment)
}
